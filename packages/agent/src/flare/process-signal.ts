 ...
 * that hash to verify the signature. (A Foundry cross-check will pin byte-for-byte equality once the
 * env is up; this module is self-consistent via the decode round-trip test.)
 */
